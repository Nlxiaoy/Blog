...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.FileUsage = field.NewString(tableName, "file_usage")
...
func (f *file) updateTableName(table string) *file {
	...
	f.FileUsage = field.NewString(table, "file_usage")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["file_usage"] = f.FileUsage
